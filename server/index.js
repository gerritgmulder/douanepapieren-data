...
// ============================================================
// Toegang: ingelogd én dolf@fonteyn.nl of fonteynbot (= Gerrits dagelijkse
// admin-login). De extra wachtwoord-laag ('Meerveld') zit aan de frontend-
// kant; hier checken we alleen op e-mail om te voorkomen dat een ander
// Logic4-account toch de endpoints aanroept met een gestolen sessie-id.
